...
// Не могу найти решение данной задачи. Обратился так же к наставнику данной темы. Ответ пока не получил.
// Не понимаю, как создать новый массив на основе старого, то что придумал, либо не работает, либо оформлено не верно